...
public class BOMCheckTest {
  ...
  public void should_find_that_the_UTF8_file_starts_with_a_BOM_and_raise_an_issue() {
    CssCheckVerifier.verify(new BOMCheck(), CheckTestUtils.getCssTestFile("utf8WithBom.css"));
  }

  @Test
  public void should_find_that_the_UTF8_file_does_not_start_with_a_BOM_and_not_raise_any_issue() {
    CssCheckVerifier.verify(new BOMCheck(), CheckTestUtils.getCssTestFile("utf8WithoutBom.css"));
  }
  ...
  public void should_find_that_the_UTF16_files_start_with_a_BOM_but_not_raise_any_issue() {
    CssCheckVerifier.verify(
      new BOMCheck(),
      CheckTestUtils.getCssTestFile("utf16BE.css"),
      Charsets.UTF_16BE);

    CssCheckVerifier.verify(
      new BOMCheck(),
      CheckTestUtils.getCssTestFile("utf16LE.css"),
      Charsets.UTF_16LE);
  }
