...
public class LessSquidSensorTest {
  ...
  public void should_create_a_valid_sensor_descriptor() {
    ...
    assertThat(descriptor.name()).isEqualTo("Less Analyzer");
  ...
  // TODO: use Less specific rules
  private void should_execute_and_save_issues(String fileName) {
    inputFile(fileName);

    ActiveRules activeRules = (new ActiveRulesBuilder())
      .create(RuleKey.of(CheckList.LESS_REPOSITORY_KEY, "S1135"))
      .activate()
